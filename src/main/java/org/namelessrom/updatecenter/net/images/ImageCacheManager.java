...
/**
 * Implementation of volley's ImageCache interface. This manager tracks the application image
 * loader and cache.
 *
...
public class ImageCacheManager implements ImageCache {
    ...
    public static ImageCacheManager getInstance() {
        if (mInstance == null) { mInstance = new ImageCacheManager(); }
    ...
    public void init(Context context, String uniqueName, int cacheSize,
        ...
        mImageLoader = new ImageLoader(Application.getRequestQueue(), this);
    }
     ...
     */
    private String createKey(String url) { return String.valueOf(url.hashCode()); }
