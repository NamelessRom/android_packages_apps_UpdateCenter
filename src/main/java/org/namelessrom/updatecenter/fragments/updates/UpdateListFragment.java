...
public class UpdateListFragment extends AttachListFragment implements OnRefreshListener, Constants,
    ...
    private Crouton meteredCrouton;
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (Helper.isMetered(getActivity())) {
            meteredCrouton = Crouton.makeText(getActivity(), R.string.metered_notice,
                    new Style.Builder().setBackgroundColorValue(Style.holoBlueLight).build());
            meteredCrouton.setOnClickListener(this).setConfiguration(
...
//
                ...
                public void run() {
                    ...
                    if (isSuccess) {
                        ...
                        errorCrouton = Crouton.makeText(getActivity(),
                                R.string.data_connection_required,
                                new Style.Builder().setBackgroundColorValue(Style.holoRedLight)
                                        .build()
                        );
                        errorCrouton.setConfiguration(new Configuration.Builder()
    ...
    @Override public void onClick(View view) {
        if (meteredCrouton != null) {
            Crouton.hide(meteredCrouton);
            meteredCrouton = null;
        }
    }
}
