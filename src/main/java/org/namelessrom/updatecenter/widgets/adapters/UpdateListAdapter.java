...
public class UpdateListAdapter extends BaseAdapter implements Constants {
        ...
        if (!updateChannel.equals("?")) {
            ...
            viewHolder.mOverflow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    showDialog(viewHolder.mUpdateState, updateInfo, downloadItem);
                }
            });
        } else { // TODO uncomment
    ...
    private void showDialog(final int state, final UpdateInfo updateInfo, final DownloadItem item) {
        final AlertDialog.Builder dialog = new AlertDialog.Builder(mContext);

        if (ViewHolder.UPDATE_DOWNLOADED == state) {
        ...
        } else if (ViewHolder.UPDATE_DOWNLOADING == state) {
            if (item != null) {
        ...
        final int msgId = (ViewHolder.UPDATE_DOWNLOADING == state
