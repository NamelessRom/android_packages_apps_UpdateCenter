...
public class CustomViewBehind extends ViewGroup {
    ...
    public void setSecondaryContent(View v) {
        if (mSecondaryContent != null) { removeView(mSecondaryContent); }
        mSecondaryContent = v;
    ...
    public void setMode(int mode) {
        if (mode == SlidingMenu.LEFT || mode == SlidingMenu.RIGHT) {
            ...
            if (mSecondaryContent != null) { mSecondaryContent.setVisibility(View.INVISIBLE); }
        }
        mMode = mode;
    }
    ...
    public void scrollBehindTo(View content, int x, int y) {
        ...
        if (vis == View.INVISIBLE) { logDebug(TAG, "behind INVISIBLE"); }
        setVisibility(vis);
    }
    ...
    public boolean menuTouchInQuickReturn(View content, int currPage, float x) {
        ...
        } else if (mMode == SlidingMenu.RIGHT || (mMode == SlidingMenu.LEFT_RIGHT && currPage ==
                2)) {
    ...
    public void drawSelector(View content, Canvas canvas, float openPercent) {
        ...
        if (mSelectorDrawable != null && mSelectedView != null) {
            ...
            if (tag != null && tag.equals(TAG + "SelectedView")) {
                canvas.save();
