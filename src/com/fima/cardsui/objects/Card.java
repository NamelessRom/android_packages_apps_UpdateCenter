...
public abstract class Card extends AbstractCard {
    ...
    public void OnSwipeCard() {
        if (onCardSwipedListener != null) { onCardSwipedListener.onCardSwiped(this, mCardLayout); }
    ...
    protected int getCardLayout() {
        return R.layout.card_item_card;
    }
    ...
    protected int getLastCardLayout() {
        return R.layout.card_item_card_empty_last;
    }

    protected int getFirstCardLayout() {
        return R.layout.card_item_play_card_empty_first;
    }
