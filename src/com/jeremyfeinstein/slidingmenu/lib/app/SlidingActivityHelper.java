...
public class SlidingActivityHelper {
    ...
    /**
     * Sets mSlidingMenu as a newly inflated SlidingMenu. Should be called within the activitiy's
     * onCreate()
     *
     * @param savedInstanceState the saved instance state (unused)
     */
    public void onCreate(Bundle savedInstanceState) {
        mSlidingMenu = (SlidingMenu) LayoutInflater.from(mActivity)
                .inflate(R.layout.slidingmenumain, null);
    }
     ...
     * state can be
     * restored in onCreate(Bundle) or onRestoreInstanceState(Bundle) (the Bundle populated by
     * this method
     ...
     * activity's view
     * hierarchy. It can itself be a complex view hierarchy. When calling this method,
     * the layout parameters
     * of the specified view are ignored. Both the width and the height of the view are set by
     * default to
    ...
    /**
     * Set the behind view content to an explicit view. This view is placed directly into the
     * behind view 's view hierarchy.
